...
public class CalculatorTest {
    ...
    public void calculateTwoTokensTestValidHalve() throws AssertException
    {
        try
        {
        	...
        	Assert.assertEquals(2, result);// TODO: complete this test...
        }
        catch (Exception e)
        {
        	Assert.fail("Legal expression threw an Exception: " + e.getMessage());
    ...
    public void calculateTwoTokensTestInvalidCommand() throws AssertException
    {
    	try
        {
            Calculator.calculateTwoTokens(new String[] {"test", "8"});
            Assert.fail("Illegal expression did not throw an Exception");
        }
    ...
    public void calculateThreeTokensTestValidAdd() throws AssertException
    {
        try
        {
        	...
        	Assert.assertEquals(10, result);// TODO: complete this test...
        }
        catch (Exception e)
        {
        	Assert.fail("Legal expression threw an Exception: " + e.getMessage());
    ...
    public void calculateThreeTokensTestValidSubtract() throws AssertException
    {
        ...
        {
        	int result = Calculator.calculateThreeTokens(new String[] {"8", "-", "2"});
        	Assert.assertEquals(6, result);// TODO: complete this test...
        }
        catch (Exception e)
        {
        	Assert.fail("Legal expression threw an Exception: " + e.getMessage());
    ...
    public void calculateThreeTokensTestValidDivide() throws AssertException
    {
        ...
        {
        	int result = Calculator.calculateThreeTokens(new String[] {"8", "/", "2"});
        	Assert.assertEquals(4, result);// TODO: complete this test...
        }
        catch (Exception e)
        {
        	Assert.fail("Legal expression threw an Exception: " + e.getMessage());
    ...
    public void calculateThreeTokensTestInvalidCommand() throws AssertException
    {
    	try
        {
            Calculator.calculateThreeTokens(new String[] {"5", "~", "10"});
            Assert.fail("Illegal expression did not throw an Exception");
        }
        catch (CalculatorException e)
        {
    ...
    {
        try{
        	int result = Calculator.execute(new String[] {"2", "+", "3"});
        	Assert.assertEquals(5, result);// TODO: complete this test...
        }
        catch (Exception e)
        {
        	Assert.fail("Legal expression threw an Exception: " + e.getMessage());
